...
# 2. Register an application at https://github.com/settings/applications Insert
# your values below - if secret is omitted, it will look it up in the
# GITHUB_CONSUMER_SECRET environmental variable.
# 
